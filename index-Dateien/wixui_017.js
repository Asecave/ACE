((typeof self !== 'undefined' ? self : this)["webpackJsonp_wix_ui_santa"] = (typeof self !== 'undefined' ? self : this)["webpackJsonp_wix_ui_santa"] || []).push([[41],{
...
exports.default = __webpack_require__.stylable.create(
  "root",
  "ProgressBar979327119",
  {"mixin-range-track":"ProgressBar979327119--mixin-range-track","mixin-range-thumb":"ProgressBar979327119--mixin-range-thumb","container":"ProgressBar979327119--container","loading":"ProgressBar979327119--loading","progress":"ProgressBar979327119--progress","range":"ProgressBar979327119--range","root":"ProgressBar979327119--root","range-track-height":"4px","range-thumb-height":"4px","range-thumb-hover-height":"12px","range-thumb-bg":"#fff","border-radius":"50px","progress-size":"12px","progress-bar-stripes":"ProgressBar979327119--progress-bar-stripes"},
  "",
  1,
  /*! ../node_modules/@wix/soundhead-react/dist/es/src/components/ProgressBar/ProgressBar.st.css */ 201
);
...
exports.default.$skin.$render = function render_css($id, $params, $functions) {
  return "\n" + $id + " .PlayPauseAnimated1236730621--button{display: block;width: 20px;height: 20px;padding: 0;border: 0;fill: currentColor;background: transparent;cursor: pointer;color: currentColor;transition: color .4s ease, opacity .4s ease}\n" + $id + " .ArtistName938326743--title{color: inherit;font-size: 16px;line-height: 1;display: inline-block;overflow: hidden;white-space: nowrap;text-overflow: ellipsis}\n" + $id + " .TimeStamp2082466461--time{display: block;padding: 4px 0 4px 12px;opacity: .6;font-size: 12px;line-height: 1;white-space: nowrap;font-family: Helvetica Neue, HelveticaNeue-Light, Helvetica Neue Light, Avenir, Gordita, Helvetica, Arial, sans-serif}\n" + $id + " .TrackName216697800--title{color: inherit;font-size: 16px;line-height: 1;display: inline-block;overflow: hidden;white-space: nowrap;text-overflow: ellipsis}\n" + $id + " .PlayPause2908839122--button{display: block;width: 16px;height: 20px;padding: 0;border: 0;fill: currentColor;background: transparent;cursor: pointer;color: currentColor;transition: color .4s ease, opacity .4s ease}\n" + $id + " .Cover2664159114--cover{display: block;width: 70px;height: 70px;background-position: center;background-size: cover}\n" + $id + " .ProgressBar979327119--mixin-range-track{background: transparent;border: 0;border-radius: 50px;height: 100%;user-select: none}\n" + $id + " .ProgressBar979327119--mixin-range-thumb{background: #fff;border: 0;border-radius: 50px;height: 4px;width: 4px;margin: 0;position: relative;transition: all 0.3s ease}\n" + $id + " .ProgressBar979327119--container{position: relative;width: 100%;height: 4px;margin: 8px 0}\n" + $id + " .ProgressBar979327119--container::before, " + $id + " .ProgressBar979327119--container::after{content: '';position: absolute;top: 0;left: 0;width: 100%;height: 100%;border-radius: 50px;display: none}\n" + $id + " .ProgressBar979327119--container::before{display: block;opacity: .2;background: currentColor}\n@keyframes ProgressBar979327119--progress-bar-stripes{\n  from{background-position: 12px 0}\n  to{background-position: 0 0}\n}\n" + $id + " .ProgressBar979327119--container.ProgressBar979327119--loading::after{display: block;pointer-events: none;opacity: .15;background: linear-gradient(45deg,currentColor 25%,transparent 25%,transparent 50%,currentColor 50%,currentColor 75%,transparent 75%,transparent);background-size: 12px 12px;animation: ProgressBar979327119--progress-bar-stripes 1s linear infinite}\n" + $id + " .ProgressBar979327119--progress{position: absolute;top: 0;left: 0;width: 100%;height: 100%;margin: 0;border: 0;border-radius: 50px;background-color: transparent;color: currentColor;opacity: .3;-webkit-appearance: none}\n" + $id + " .ProgressBar979327119--progress::-webkit-progress-bar{background-color: transparent;border-radius: 50px}\n" + $id + " .ProgressBar979327119--progress::-moz-progress-bar{background-color: currentColor;border-radius: 50px}\n" + $id + " .ProgressBar979327119--progress::-webkit-progress-value{background-color: currentColor;border-radius: 50px}\n" + $id + " .ProgressBar979327119--progress::-ms-fill{border-radius: 50px}\n" + $id + " .ProgressBar979327119--range{position: absolute;top: -8px;left: 0;width: 100%;height: 100%;display: block;box-sizing: content-box;padding: 8px 0;margin: 0;border: 0;border-radius: 50px;background: transparent;color: currentColor;transition: color 0.3s ease;cursor: pointer;-webkit-appearance: none}\n" + $id + " .ProgressBar979327119--range::-webkit-slider-runnable-track{background: transparent;border: 0;border-radius: 50px;height: 100%;user-select: none;background-image: linear-gradient(to right,currentColor var(--value,0%),transparent var(--value,0%))}\n" + $id + " .ProgressBar979327119--range::-webkit-slider-thumb{background: #fff;border: 0;border-radius: 50px;height: 4px;width: 4px;margin: 0;position: relative;transition: all 0.3s ease;transform: translateX(var(--value,0%));margin-left: -2px;-webkit-appearance: none}\n" + $id + " .ProgressBar979327119--range::-moz-range-track{background: transparent;border: 0;border-radius: 50px;height: 100%;user-select: none}\n" + $id + " .ProgressBar979327119--range::-moz-range-thumb{background: #fff;border: 0;border-radius: 50px;height: 4px;width: 4px;margin: 0;position: relative;transition: all 0.3s ease;transform: translateX(-2px)}\n" + $id + " .ProgressBar979327119--range::-moz-range-progress{background: currentColor;border-radius: 50px;height: 100%}\n" + $id + " .ProgressBar979327119--range::-moz-focus-outer{border: 0}\n" + $id + " .ProgressBar979327119--range:hover::-webkit-slider-thumb, " + $id + " .ProgressBar979327119--range:active::-webkit-slider-thumb{transform: scale(3)}\n" + $id + " .ProgressBar979327119--range:hover::-moz-range-thumb, " + $id + " .ProgressBar979327119--range:active::-moz-range-thumb{transform: scale(3)}\n" + $id + " .ProgressBar979327119--range:hover::-ms-thumb, " + $id + " .ProgressBar979327119--range:active::-ms-thumb{transform: scale(3)}\n" + $id + " .Mute374069603--button{display: block;padding: 0;border: 0;background: transparent;outline: 0;cursor: pointer;color: inherit;transition: color .4s ease, opacity .4s ease}\n" + $id + " .Rate1867267189--button{display: block;padding: 0;border: 0;background: transparent;outline: 0;cursor: pointer;color: inherit;transition: color .4s ease, opacity .4s ease}\n" + $id + " .Forward2903339977--button{display: block;padding: 0;border: 0;background: transparent;outline: 0;cursor: pointer;color: inherit;transition: color .4s ease, opacity .4s ease}\n" + $id + ".MusicPlayer2902040282--root{box-shadow: none;border: " + $params["borderSize"] + " solid " + $params["borderColor"] + ";border-radius: " + $params["borderRadius"] + ";position: relative;width: 100%;height: 70px;text-align: left;background: " + $params["backgroundColor"] + ";color: " + $params["regularColor"] + ";font: " + $params["font"] + ";overflow: hidden;box-sizing: border-box;display: flex}\n" + $id + " .MusicPlayer2902040282--title{text-align: left;font-size: inherit}\n" + $id + " .MusicPlayer2902040282--title + .MusicPlayer2902040282--title{opacity: 0.6}\n" + $id + " .MusicPlayer2902040282--title + .MusicPlayer2902040282--title::before{content: '-';padding: 0.4em;opacity: 1}\n" + $id + " .MusicPlayer2902040282--title:empty + .MusicPlayer2902040282--title::before{content: '';display: none}\n" + $id + " .MusicPlayer2902040282--title + .MusicPlayer2902040282--title:empty::before{content: '';display: none}\n" + $id + " .MusicPlayer2902040282--cover{height: 100%;width: 100%}\n" + $id + " .MusicPlayer2902040282--progressRangeBar::-webkit-slider-thumb{background-color: " + $params["regularColor"] + "}\n" + $id + " .MusicPlayer2902040282--progressRangeBar::-moz-range-thumb{background-color: " + $params["regularColor"] + "}\n" + $id + " .MusicPlayer2902040282--progressRangeBar:hover{color: " + $params["hoverColor"] + "}\n" + $id + " .MusicPlayer2902040282--playButton:hover{color: " + $params["hoverColor"] + "}\n" + $id + " .MusicPlayer2902040282--titleLayout{display: flex;overflow: hidden;white-space: nowrap;text-overflow: ellipsis}\n" + $id + " .MusicPlayer2902040282--progressLayout{width: auto;flex-grow: 1}\n" + $id + " .MusicPlayer2902040282--timeStamp{opacity: 1;font-size: 12px;line-height: 16px;padding: 2px 0}\n" + $id + " .MusicPlayer2902040282--playLayout{margin-right: 14px}\n" + $id + " .MusicPlayer2902040282--mainLayout{display: flex;flex-direction: column;justify-content: space-around;padding: 12px 16px;width: 100%;overflow: hidden;box-sizing: border-box}\n" + $id + " .MusicPlayer2902040282--upperLayout{display: flex;box-sizing: border-box;width: 100%}\n" + $id + " .MusicPlayer2902040282--lowerLayout{display: flex;align-items: center;width: 100%}\n" + $id + " .MusicPlayer2902040282--coverLayout{width: 70px;flex: 0 0 70px}\n" + $id + ".MusicPlayer2902040282--root[data-musicplayer2902040282-hassinglerow]{height: 40px}\n" + $id + ".MusicPlayer2902040282--root[data-musicplayer2902040282-hasprogressbar] .MusicPlayer2902040282--timeStamp{opacity: 0.6;padding-left: 12px}\n" + $id + ".MusicPlayer2902040282--root[data-musicplayer2902040282-hasonlyplay] .MusicPlayer2902040282--playLayout{position: absolute;left: 50%;top: 50%;transform: translate(-50%,-50%);margin-right: 0}\n" + $id + ".MusicPlayer2902040282--root[data-musicplayer2902040282-hassinglerow] .MusicPlayer2902040282--coverLayout{width: 40px;flex-basis: 40px}\n" + $id + ".MusicPlayer2902040282--root[data-musicplayer2902040282-hastitletimerow] .MusicPlayer2902040282--timeStamp{font-size: 14px;padding-left: 12px}\n" + $id + ".MusicPlayer2902040282--root[data-musicplayer2902040282-ishoverstate] .MusicPlayer2902040282--playButton, " + $id + ".MusicPlayer2902040282--root[data-musicplayer2902040282-ishoverstate] .MusicPlayer2902040282--progressRangeBar{color: " + $params["hoverColor"] + "}\n";
};
...
var _soundheadReact = __webpack_require__(/*! @wix/soundhead-react */ 856);
...
var _MusicPlayer3 = __webpack_require__(/*! ./MusicPlayer.santa */ 461);
...
exports.default = __webpack_require__.stylable.create(
  "root",
  "ArtistName938326743",
  {"title":"ArtistName938326743--title","root":"ArtistName938326743--root"},
  "",
  1,
...
exports.default = __webpack_require__.stylable.create(
  "root",
  "Cover2664159114",
  {"cover":"Cover2664159114--cover","root":"Cover2664159114--root"},
  "",
  1,
...
exports.default = __webpack_require__.stylable.create(
  "root",
  "TimeStamp2082466461",
  {"time":"TimeStamp2082466461--time","root":"TimeStamp2082466461--root"},
  "",
  1,
...
exports.default = __webpack_require__.stylable.create(
  "root",
  "TrackName216697800",
  {"title":"TrackName216697800--title","root":"TrackName216697800--root"},
  "",
  1,
...
exports.default = __webpack_require__.stylable.create(
  "root",
  "PlayPause2908839122",
  {"button":"PlayPause2908839122--button","root":"PlayPause2908839122--root"},
  "",
  1,
...
exports.default = __webpack_require__.stylable.create(
  "root",
  "PlayPauseAnimated1236730621",
  {"button":"PlayPauseAnimated1236730621--button","root":"PlayPauseAnimated1236730621--root"},
  "",
  1,
...
exports.default = __webpack_require__.stylable.create(
  "root",
  "Mute374069603",
  {"button":"Mute374069603--button","root":"Mute374069603--root"},
  "",
  1,
...
exports.default = __webpack_require__.stylable.create(
  "root",
  "Rate1867267189",
  {"button":"Rate1867267189--button","root":"Rate1867267189--root"},
  "",
  1,
...
exports.default = __webpack_require__.stylable.create(
  "root",
  "Forward2903339977",
  {"button":"Forward2903339977--button","root":"Forward2903339977--root"},
  "",
  1,
...
var _musicPlayerBehaviors = __webpack_require__(/*! ./behaviors/musicPlayerBehaviors */ 462);

var _MusicPlayer = __webpack_require__(/*! ./MusicPlayer */ 306);

var _MusicPlayer2 = _interopRequireDefault(_MusicPlayer);

var _events = __webpack_require__(/*! ./bi/events */ 463);

var _events2 = _interopRequireDefault(_events);

var _url = __webpack_require__(/*! ../../utils/url */ 96);
...
var eventemitter3 = __webpack_require__(42);
...
var ProgressBar_st = __webpack_require__(201);
