((typeof self !== 'undefined' ? self : this)["webpackJsonp_wix_ui_santa"] = (typeof self !== 'undefined' ? self : this)["webpackJsonp_wix_ui_santa"] || []).push([[54],{
...
var getSDK_1 = __webpack_require__(/*! ./getSDK */ 622);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../webpack/buildin/global.js */ 21), __webpack_require__(/*! ./../process/browser.js */ 204)))
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../webpack/buildin/global.js */ 21), __webpack_require__(/*! ./../../../timers-browserify/main.js */ 620).setImmediate))
...
var _env = __webpack_require__(/*! ./env */ 121);
...
var _require = __webpack_require__(/*! ./utils/collections */ 636),
    mapValues = _require.mapValues;

var promise = __webpack_require__(/*! ./utils/promise */ 637);

var _require2 = __webpack_require__(/*! ./utils/log */ 638),
    log = _require2.log;
  ...
  _createClass(BiLogger, [{
    ...
    value: function log(eventOrKey, eventOrContextOrUndefined, contextOrUndefined) {
      ...
      return this._getDefaults().then(function (defaults) {
        ...
        return Promise.all(_this._publishers.map(function (publisher) {
          var cloned = Object.assign({}, fullEvent);

          return Promise.resolve().then(function () {
            return publisher(cloned, Object.assign({}, _this._context, context));
          }).catch(function (error) {
            return _this._onPublisherFailHandler(error, { publisherName: publisher.name });
          });
        })).then(function () {
          return undefined;
        });
      ...
      var promises = mapValues(this._defaults, function (value, key) {
        if (typeof value === 'function') {
          try {
            ...
            return _this2._handleDefaultsError(err);
          }
        }
        ...
        return promise.timedPromise(value, {
          ...
          timeout: _this2._defaultValueTimeout
        }).catch(function (err) {
          return _this2._handleDefaultsError(err);
        });
      });
...
exports.default.$skin.$render = function render_css($id, $params, $functions) {
  return "\n" + $id + ".Video3650792902--root{position: relative}\n" + $id + " .Video3650792902--playerContainer{position: relative;height: 100%;width: 100%;background-color: #000}\n" + $id + " .Video3650792902--playerContainer iframe{height: 100%;width: 100%;visibility: visible}\n" + $id + " .Video3650792902--cover{position: absolute;top: 0;left: 0;height: 100%;width: 100%;background: #000 50% 50% no-repeat;background-size: cover;cursor: pointer}\n" + $id + " .Video3650792902--cover.Video3650792902--transparentOverlay{background: transparent}\n" + $id + " .Video3650792902--overlay{display: flex;height: 100%;justify-content: center;flex-direction: column;align-items: center;background-color: rgba(0,0,0,0.35)}\n" + $id + " .Video3650792902--title{margin: 0 15px 15px;text-align: center}\n" + $id + ".VideoPlayer4111471387--root{box-shadow: " + $params["boxShadow"] + ";border: " + $params["borderSize"] + " solid " + $params["borderColor"] + ";margin-top: calc(-1 * " + $params["borderSize"] + ");margin-left: calc(-1 * " + $params["borderSize"] + ")}\n" + $id + ".VideoPlayer4111471387--root .Video3650792902--title{font: " + $params["font"] + ";color: " + $params["fontColor"] + ";margin: 0 0 15px;padding: 0 .2em;display: -webkit-box;-webkit-line-clamp: 2;-webkit-box-orient: vertical;overflow: hidden;max-height: 2.8em}\n" + $id + ".VideoPlayer4111471387--root[data-videoplayer4111471387-ismobileview] .Video3650792902--title{font-size: calc(18 * " + $params["textSizeScale"] + ");margin: 0 0 10px}\n" + $id + ".VideoPlayer4111471387--root .Video3650792902--overlay{background-color: " + $params["backgroundColor"] + ";padding: 0 10%;transition: opacity .2s ease}\n" + $id + ".VideoPlayer4111471387--root .VideoPlayer4111471387--playButton{display: block;width: " + $params["playButtonSize"] + ";height: " + $params["playButtonSize"] + ";padding: 0;border: 0;background: transparent;box-sizing: border-box;cursor: pointer;transition: opacity .2s ease}\n" + $id + ".VideoPlayer4111471387--root .VideoPlayer4111471387--playButton:hover{opacity: .8}\n" + $id + ".VideoPlayer4111471387--root[data-videoplayer4111471387-ismobileview] .VideoPlayer4111471387--playButton{width: " + $params["playButtonMobileSize"] + ";height: " + $params["playButtonMobileSize"] + "}\n" + $id + " .VideoPlayer4111471387--playButton circle{stroke: " + $params["fontColor"] + "}\n" + $id + " .VideoPlayer4111471387--playButton path{fill: " + $params["fontColor"] + "}\n";
};
...
var _VideoPlayer = __webpack_require__(/*! ./VideoPlayer */ 614);
...
exports.default = __webpack_require__.stylable.create(
  "root",
  "Video3650792902",
  {"root":"Video3650792902--root","playerContainer":"Video3650792902--playerContainer","cover":"Video3650792902--cover","transparentOverlay":"Video3650792902--transparentOverlay","overlay":"Video3650792902--overlay","title":"Video3650792902--title"},
  "",
  1,
  /*! ../node_modules/wix-ui-core/dist/src/components/video/Video.st.css */ 57
);
...
var _video = __webpack_require__(/*! wix-ui-core/video */ 615);

var _playbackBiModule = __webpack_require__(/*! @wix/playback-bi-module */ 628);

var _events = __webpack_require__(/*! ./bi/events */ 642);

var _videoPlayerBehaviors = __webpack_require__(/*! ./behaviors/videoPlayerBehaviors */ 643);

var _VideoPlayerSt = __webpack_require__(/*! ./VideoPlayer.st.css */ 350);

var _VideoPlayerSt2 = _interopRequireDefault(_VideoPlayerSt);

var _playButtonIcon = __webpack_require__(/*! ./playButtonIcon */ 644);
...
module.exports = __webpack_require__(/*! ./dist/src/components/video */ 616);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Video_1 = __webpack_require__(/*! ./Video */ 617);
...
var React = __webpack_require__(/*! react */ 0);
var players_1 = __webpack_require__(/*! ./players */ 618);
var Video_st_css_1 = __webpack_require__(/*! ./Video.st.css */ 57);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Playable_1 = __webpack_require__(/*! ./Playable */ 619);
var YouTube_1 = __webpack_require__(/*! ./YouTube */ 621);
var Facebook_1 = __webpack_require__(/*! ./Facebook */ 624);
var Vimeo_1 = __webpack_require__(/*! ./Vimeo */ 625);
var Twitch_1 = __webpack_require__(/*! ./Twitch */ 626);
var DailyMotion_1 = __webpack_require__(/*! ./DailyMotion */ 627);
// @TODO enum ?
...
var tslib_1 = __webpack_require__(/*! tslib */ 6);
var React = __webpack_require__(/*! react */ 0);
var eventemitter3_1 = __webpack_require__(/*! eventemitter3 */ 42);
var classnames_1 = __webpack_require__(/*! classnames */ 4);
var isString = __webpack_require__(/*! lodash/isString */ 92);
var isArray = __webpack_require__(/*! lodash/isArray */ 237);
var playable_1 = __webpack_require__(/*! playable */ 346);
var constants_1 = __webpack_require__(/*! ../constants */ 56);
var playerHOC_1 = __webpack_require__(/*! ./playerHOC */ 93);
var Video_st_css_1 = __webpack_require__(/*! ../Video.st.css */ 57);
...
var eventemitter3_1 = __webpack_require__(/*! eventemitter3 */ 42);
var isString = __webpack_require__(/*! lodash/isString */ 92);
var utils_1 = __webpack_require__(/*! ../utils */ 120);
var constants_1 = __webpack_require__(/*! ../constants */ 56);
var playerHOC_1 = __webpack_require__(/*! ./playerHOC */ 93);
var Video_st_css_1 = __webpack_require__(/*! ../Video.st.css */ 57);
    ...
    function YouTubePlayer(props) {
        ...
        _this.initPlayer = function (YT) {
            ...
            _this.player = new YT.Player(_this.containerRef.current, {
                ...
                height: '100%',
                videoId: videoId,
                playerVars: tslib_1.__assign({ autoplay: playing ? 1 : 0, mute: muted ? 1 : 0, controls: controls ? 1 : 0, loop: loop ? 1 : 0, origin: window.location.origin, playsinline: true }, (loop && { playlist: videoId }), playerOptions),
                events: {
                    onReady: function () {
                        onReady();
                        onDuration(_this.player.getDuration());
...
Object.defineProperty(exports, "__esModule", { value: true });
var originalLoadjs = __webpack_require__(/*! loadjs */ 623);
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./playback-bi-module */ 629));
//# sourceMappingURL=index.js.map
...
Object.defineProperty(exports, "__esModule", { value: true });
var playable_1 = __webpack_require__(/*! playable */ 346);
var web_bi_logger_1 = __importDefault(__webpack_require__(/*! @wix/web-bi-logger */ 630));
var bi_logger_video_platform_1 = __importDefault(__webpack_require__(/*! @wix/bi-logger-video-platform */ 641));
...
var _tracker = __webpack_require__(/*! ./lib/tracker */ 631);

var tracker = _interopRequireWildcard(_tracker);

var _logger = __webpack_require__(/*! ./logger */ 633);
...
var _navigator = __webpack_require__(/*! ./navigator */ 632);
...
var _wixBiLoggerClient = __webpack_require__(/*! @wix/wix-bi-logger-client */ 634);

var _env = __webpack_require__(/*! ./lib/env */ 121);

var env = _interopRequireWildcard(_env);

var _publishers = __webpack_require__(/*! ./lib/publishers */ 639);
...
var BiLoggerClientFactory = __webpack_require__(/*! ./bi-logger-factory */ 635);
...
var _transport = __webpack_require__(/*! ./transport */ 640);
